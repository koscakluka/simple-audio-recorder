...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   RecorderStates: () => (/* binding */ RecorderStates),
/* harmony export */   SimpleAudioRecorder: () => (/* binding */ SimpleAudioRecorder),
/* harmony export */   preloadWorker: () => (/* binding */ preloadWorker),
/* harmony export */   useSimpleAudioRecorder: () => (/* binding */ useSimpleAudioRecorder)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _AudioRecorder_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AudioRecorder.js */ "./src/AudioRecorder.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function useInterval(updateFunc) {
  var timeStep = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1000 / 60.0;
...
function useSimpleAudioRecorder() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    ...
    onDataAvailable = _ref.onDataAvailable,
    onComplete = _ref.onComplete,
    onError = _ref.onError,
    options = _ref.options,
    _ref$cleanup = _ref.cleanup,
    cleanup = _ref$cleanup === void 0 ? false : _ref$cleanup,
    _ref$timeUpdateStep = _ref.timeUpdateStep,
    timeUpdateStep = _ref$timeUpdateStep === void 0 ? 111 : _ref$timeUpdateStep,
    _ref$countdown = _ref.countdown,
    countdown = _ref$countdown === void 0 ? 0 : _ref$countdown;
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(RecorderStates.INITIAL),
    _useState2 = _slicedToArray(_useState, 2),
    recorderState = _useState2[0],
    setRecorderState = _useState2[1];
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
    _useState4 = _slicedToArray(_useState3, 2),
    mp3Blobs = _useState4[0],
    setMp3Blobs = _useState4[1];
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
    _useState6 = _slicedToArray(_useState5, 2),
    mp3Urls = _useState6[0],
    setMp3Urls = _useState6[1];
  ...
  var _useState11 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null),
    ...
    countdownStartTime = _useState12[0],
    setCountdownStartTime = _useState12[1];
  var _useState13 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
    _useState14 = _slicedToArray(_useState13, 2),
    countdownTimeLeft = _useState14[0],
    setCountdownTimeLeft = _useState14[1];
  var recorderStateRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(recorderState);
  var countdownStartTimeRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(0);
  var recorderRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  var audioDataRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  var countdownTimerRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (workerUrl) {
      _AudioRecorder_js__WEBPACK_IMPORTED_MODULE_1__["default"].preload(workerUrl);
    }
    return function () {
  ...
  function start() {
    ...
    recorderRef.current = new _AudioRecorder_js__WEBPACK_IMPORTED_MODULE_1__["default"](_objectSpread(_objectSpread({}, options), {}, {
      streaming: true
    }));
    setRecorderState(RecorderStates.STARTING);
    setCountdownTimeLeft(countdown);
    recorderRef.current.ondataavailable = function (data) {
      audioDataRef.current.push(data);
      onDataAvailable && onDataAvailable(data);
    };
    recorderRef.current.onstart = function () {
      if (countdown > 0) {
        setRecorderState(RecorderStates.COUNTDOWN);
        setCountdownStartTime(Date.now());
        countdownTimerRef.current = setTimeout(function () {
          if (recorderStateRef.current == RecorderStates.COUNTDOWN) {
    ...
    recorderRef.current.onstop = function () {
      ...
      var mp3Blob = new Blob(audioDataRef.current, {
        type: "audio/mpeg"
      });
      var mp3Url = URL.createObjectURL(mp3Blob);
      setRecorderState(RecorderStates.COMPLETE);
      setMp3Blobs([].concat(_toConsumableArray(mp3Blobs), [mp3Blob]));
      setMp3Urls([].concat(_toConsumableArray(mp3Urls), [mp3Url]));
      onComplete && onComplete({
        mp3Blob: mp3Blob,
        mp3Url: mp3Url
      });
    };
    recorderRef.current.onerror = function (error) {
...
function SimpleAudioRecorder(_ref2) {
  var _stateMap$get;
  var recorderState = _ref2.recorderState,
    viewInitial = _ref2.viewInitial,
    viewStarting = _ref2.viewStarting,
    viewCountdown = _ref2.viewCountdown,
    viewRecording = _ref2.viewRecording,
    viewPaused = _ref2.viewPaused,
    viewEncoding = _ref2.viewEncoding,
    viewComplete = _ref2.viewComplete,
    viewError = _ref2.viewError;
  ...
  viewStarting = viewStarting !== null && viewStarting !== void 0 ? viewStarting : viewCountdown !== null && viewCountdown !== void 0 ? viewCountdown : viewRecording;
  viewCountdown = viewCountdown !== null && viewCountdown !== void 0 ? viewCountdown : viewRecording;
  viewPaused = viewPaused !== null && viewPaused !== void 0 ? viewPaused : viewInitial;
  viewEncoding = viewEncoding !== null && viewEncoding !== void 0 ? viewEncoding : viewComplete;
  viewComplete = viewComplete !== null && viewComplete !== void 0 ? viewComplete : viewInitial;
  viewError = viewError !== null && viewError !== void 0 ? viewError : viewInitial;
  ...
  return (_stateMap$get = stateMap.get(recorderState)) !== null && _stateMap$get !== void 0 ? _stateMap$get : RecorderStates.INITIAL;
}
